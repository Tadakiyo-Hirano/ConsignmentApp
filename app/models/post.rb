class Post < ApplicationRecord
  ...
  validates :month_notice, presence: true, length: { maximum: 300 }
  validates :year_month, inclusion: { in: YEAR_VALUES }
  validates :year_day, inclusion: { in: DAY_VALUES }
  validates :year_notice, presence: true, length: { maximum: 300 }
  validates :reminder_month, inclusion: { in: YEAR_VALUES }
  validates :reminder_notice, length: { maximum: 300 }
